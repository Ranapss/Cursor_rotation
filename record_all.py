...
sets = [1,1,1]                                                                                         #the different sets of trials, total trials are sets * targets
angles = [0,-60,0]                                                                                       # angle distortion for each set, sets and angles must be the same size, positive is clockwise rotation        -60
distort = [False, False, False]                                                                       # true or false to use the visual distortion, 
...
#                targetC.opacity = 1
            ...
            if r> 1.05:                                                                               #set the out of bounds condition
                out = True
                target = None
                targetC.opacity = 0
                score -= 2
